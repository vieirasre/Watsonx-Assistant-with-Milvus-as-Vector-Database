...
if not utility.has_collection(COLLECTION_NAME):
    ...
    # Assuming 'embeddings' is a list of your embedding vectors
    # Here we use SentenceTransformerEmbeddings as an example
    embedding_model = SentenceTransformerEmbeddings(model_name="all-MiniLM-L6-v2")
    embeddings = [embedding_model.embed([q])[0] for q in df['question']]
    data = [
        df['id'].tolist(),  # IDs
        embeddings  # Vectors
    ]
